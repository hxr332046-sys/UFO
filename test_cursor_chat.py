#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Read Cursor chat messages and test silent send via CDP."""
...
def main():
    ...
    # === Silent Send Test ===
    print("\n" + "=" * 60)
    print("  Silent Send Test (CDP)")
    print("=" * 60)

    message = "CDP静默发送测试-Cursor"

    # Focus and type into aislash-editor-input
    js_focus = """
    (function() {
    ...
    if not focus_val.get("found"):
        print("Input not found, aborting")
        ws.close()
        return
    ...
    if verify.get("found"):
        ...
        print("\nMessage not confirmed yet (may need more time)")
