...
def main():
    ...
    expr = r"""(function(){
      function walk(vm,d,out){
        ...
        if(n==='tni-industry-select' || n==='organization-select'){
          out.push({
            name:n,
            methodKeys:Object.keys((vm.$options&&vm.$options.methods)||{}).slice(0,80),
            dataKeys:Object.keys(vm.$data||{}).slice(0,80),
            propKeys:Object.keys((vm.$options&&vm.$options.props)||{}).slice(0,40)
          });
        }
