...
init_r = ev("""(function(){
    ...
    if(!fc||!fc.$data||!fc.$data.businessDataInfo)return{error:'no_fc'};
    if(typeof fc.initData==='function'){fc.initData();return{called:'initData'}}
...
# ============================================================
# Step 3: 经营范围 - 通过businese-info confirm
# ============================================================
print("\nStep 3: 经营范围")

# 先找tni-business-range加载经营范围列表
tbr_init = ev("""(function(){
    ...
    return{allBusinessListLen:al,searchListLen:sl};
})()""")
print(f"  tni-business-range: {tbr_init}")
time.sleep(3)
